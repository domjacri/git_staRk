#holepunch script (create website)
library(holepunch)
write_compendium_description(package = "git_staRk", 
                             description = "Learn R for Beginners, Stark 2019 Edition")
# to write a description, with dependencies listed 
# It's good practice to now go fill in the placeholder text.

write_dockerfile(maintainer = "Dom J Acri") 
